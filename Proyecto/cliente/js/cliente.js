...
$('#solicitudCitas').on('click', (e) =>{
    e.preventDefault();

    window.open("solicitarCitas.php", "_self");
});

$('#medirPresupuesto').on('click', (e) =>{
    e.preventDefault();

    window.open("medirPresupuestos.php", "_self");
});
...
function escribirStorage() {
	...
	/*$.each(objPresupuestos, function(propiedad, valor) {

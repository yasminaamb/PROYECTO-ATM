...
INSERT INTO `reformas` (`idReforma`, `peon`, `cliente`) VALUES
(1, 222, 663),
(2, 222, 199),
(5, 444, 776);
...
ALTER TABLE `reformas`
  ADD PRIMARY KEY (`idReforma`),
  ADD KEY `FK_peones` (`peon`),
  ADD KEY `FK_clientes` (`cliente`);
...
--
-- Filtros para la tabla `reformas`
--
ALTER TABLE `reformas`
  ADD CONSTRAINT `FK_peones` FOREIGN KEY (`peon`) REFERENCES `peones` (`idPeon`),
  ADD CONSTRAINT `FK_clientes` FOREIGN KEY (`cliente`) REFERENCES `clientes` (`idCliente`);
COMMIT;
